    ...
    <section class="hero">
        <div class="container-fluid py-6">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5 px-5">
              ...
              <div class="col-lg-6">
                <h1 class="display-5 fw-bold lh-1 mb-3">NontonKuy - Online Platform</h1>
                <p class="lead">"NontonKuy" is an online platform that allows you to watch movies or series wherever you are, when you need to be in a good mood.</p>
